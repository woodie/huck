...
dependencies {
    ...
    // Published to Maven Central as of v0.1.2 (see kwick's own docs/COWORK.md
    // "Packaging") -- no longer a composite build, so this needs a real
    // version pin now. Bump by hand whenever a new kwick release ships.
